...
namespace Nigma\CommonBundle\Entity;
 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="Nigma\CommonBundle\Entity\PageRepository")
 */
class Page
{
     ...
     * @var string
     *
     * @ORM\Column(name="image", type="string", length=350, nullable=true)
     */
    private $image = null;
